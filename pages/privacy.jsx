export default function Privacy() {
    ...
    return (
        <div>
            <h1 className="font-semibold text-3xl text-white/75">Privacy Policy for Cloud BOT</h1>
  ...
  <div className="animateHeader text-white text-opacity-40 mt-5">
        ...
        <p>⊳ You have to vote for the <a className="text-white" href="Cooming Soon">Cloud BOT</a> bot when using certain commands from the bot commands.</p>
        <div className="py-3"></div>
        <p>⊳ Every user can use the Cloud bot however they want, as long as they do not intend to harm.</p>
        <div className="py-3"></div>
        <p>⊳ You cannot use certain commands at the same time while using Cloud BOT.</p>   
        <div className="py-3"></div>
        <p>⊳ Cloud BOT does not save any data based on users.</p>
        <div className="py-3"></div>
