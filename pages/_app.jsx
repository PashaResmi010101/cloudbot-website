...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/P8sVQj49s6",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1117143640821747772&permissions=277028620608&scope=bot%20applications.commands",
    },
       {
      link: true,
      name: "Vote",
