...
export default function Index() {
  ...
  return (
    <>
      ...
      <img width="500" src="https://media.discordapp.net/attachments/1117200488916598844/1274342661305663532/kakashi-hatake.png?ex=66c1e796&is=66c09616&hm=7dc9e291e0a733b8dea3fdb133b39185c592167915c13c61506d7e05033bf946&=&format=webp&quality=lossless" />
      </div>
       ...
       How about moderating your own server with Cloud BOT? Create your own free world and create your own playlist, experience this pleasure with the best sounds. 
        ...
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
            ...
            <Link href={"https://discord.com/oauth2/authorize?client_id=1117143640821747772&permissions=277028620608&scope=applications.commands%20bot"}>
              <a
                className={
...
Vote Cloud BOT</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"Cloud BOT" }} />
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">With fast and customizable settings specific to your server, Cloud BOT gives you a musical pleasure to the fullest.</p>
                </div>
              </div>
              <div>
                <div className="text-white">
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  <img src="https://media.discordapp.net/attachments/1117200488916598844/1274336764332605571/cloudlogo1.png?ex=66c1e218&is=66c09098&hm=77709a5a549fbbc22174190d73fab5a6c7504e2a65f81cca7f35416351fd336b&=&format=webp&quality=lossless&width=473&height=473"  width="256" className="lg:hidden rounded-xl mb-5 shadow-xl shadow-black" />
                ...
                <img src="https://media.discordapp.net/attachments/1117200488916598844/1274336764332605571/cloudlogo1.png?ex=66c1e218&is=66c09098&hm=77709a5a549fbbc22174190d73fab5a6c7504e2a65f81cca7f35416351fd336b&=&format=webp&quality=lossless&width=473&height=473" className="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black" />
              </>
